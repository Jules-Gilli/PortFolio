...
function buildBoxShadow(glowColor: string, intensity: number, innerIntensity: number): string {
  ...
  return layers.map(([x, y, blur, spread, alpha, inset]) => {
    const mult = inset ? intensity * innerIntensity : intensity;
    const a = Math.min(alpha * mult, 100);
    ...
    >
      <div
        ...
        style={{
          ...
          maskClip: 'border-box, border-box, padding-box',
          ...
          WebkitMaskClip: 'border-box, border-box, padding-box',
      ...
      >
        <span
          ...
          style={{
            inset: `${glowRadius}px`,
            boxShadow: buildBoxShadow(glowColor, glowIntensity, innerGlowIntensity),
          }}
        />
      </span>
